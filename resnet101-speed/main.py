...
class Experiments:
    ...
    @staticmethod
    def dataparallel1(model: nn.Module, devices: List[int]) -> Stuffs:
        batch_size = 64
    ...
    @staticmethod
    def dataparallel2(model: nn.Module, devices: List[int]) -> Stuffs:
        batch_size = 128
    ...
    @staticmethod
    def dataparallel4(model: nn.Module, devices: List[int]) -> Stuffs:
        batch_size = 256
...
EXPERIMENTS: Dict[str, Experiment] = {
    ...
    'dataparallel-1': Experiments.dataparallel1,
    'dataparallel-2': Experiments.dataparallel2,
    'dataparallel-4': Experiments.dataparallel4,
}
